...
<img src="images/gambar.png" alt="Admin dashboard interface for a book lending application showing navigation menus and data panels in a clean professional layout" width="700" class="align-items-center"/>
